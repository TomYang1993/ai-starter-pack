...
When the user says "set up my coding environment", "update ai-starter-pack", "update my environment", "bootstrap my agent", "install my starter pack", or starts in a fresh repo and wants their usual defaults:
